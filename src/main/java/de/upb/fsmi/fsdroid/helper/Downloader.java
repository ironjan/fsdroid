...
public class Downloader {
     ...
     *
     * @param context
     * @param uri     the file's internet uri
     * @return the downloaded file
     * @throws MalformedURLException not a correct url
     * @throws IOException           error when writing file
     * @throws ProtocolException     ?
     * @throws FileNotFoundException could not found the file
     */
